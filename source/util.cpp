...
int which_season=1;
Uint8 mode=0,phase=0,kick_count=0,pauseGame;
...
Uint8 CHOSEON=0,MAGNIFY,DASH_TYPE;
double DISTANCE_1CH,DISTANCE_62CH,RECEIPTION_LEVEL,MAP_SCALE;
Uint8 X_OF_GRAPH_VERTEX;
double FILL_GRAPH_HEIGHT;
int pre_magnify;
